...
import { Volume2, ChevronRight, ArrowLeft, Sparkles } from "lucide-react";
            ...
            return (
              <motion.button
                ...
                className={`relative rounded-2xl border p-4 text-center transition-all duration-300 group
                  bg-card border-border hover:border-primary/40 hover:shadow-md hover:-translate-y-1 active:scale-95 min-h-[120px] flex flex-col items-center justify-center`}
              >
                {!isFlipped ? (
                  <>
